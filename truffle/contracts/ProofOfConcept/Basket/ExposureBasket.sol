...
//
//        uint256 startIndex;
//        uint256 indexForWeight;
//        address _token;
//        uint256 indexDivised;
//        uint256 indexPortionForFixed;
//        uint256 indexPortionForMCAP;
//        uint256 tokenWeight;
...
//                continue;
//
//            startIndex = weightIndex[epoch];
//            indexForWeight = weightIndex[epoch];
//            _token = tokens[epoch][i];
//            updateTokenPrice(_token);
//
//            if (epoch > 0)
//                startIndex = calculateNAV(epoch - 1);
//
//            indexPortionForFixed = indexDivised * fixedWeight[epoch] / 1e18;
//            indexPortionForMCAP = indexDivised - indexPortionForFixed;
//            tokenWeight = ((tokenMarketCaps[epoch][_token] * 1e18) / indexForWeight);
//            tokenPortion = (((((indexPortionForMCAP) * tokenWeight))) / (tokenPrices[epoch][_token]));
//
...
//                {
//                    amount = (tokenPortions[epoch][_token] - tokenPortions[epoch - 1][_token]);
//                    total_amount = (amount * totalSupply()) / 1e18;
